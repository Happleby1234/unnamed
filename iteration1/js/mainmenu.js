class MainMenu extends BaseScene {
    ...
    create() {
        ...
        var startButton = this.add.text(game.config.width / 1.5, game.config.height / 2, 'Fullscreen', { fontFamily: 'Arial', fontSize: '20px', backgroundColor: '#444', fill: '#FFF' });
        var startButton2 = this.add.text(game.config.width / 3, game.config.height / 2, 'Play Game', { fontFamily: 'Arial', fontSize: '20px', backgroundColor: '#444', fill: '#FFF' });
